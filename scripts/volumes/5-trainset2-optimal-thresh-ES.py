...
thresh_optimizer_ES.compile(optimizer='adam', loss='mae')
...
thresh_optimizer_ES.fit(data_ES_train['imgs'], data_ES_train['opt_intensity_threshold'],
                        batch_size=batch_size, nb_epoch=nb_epoch, verbose=2, shuffle=True,
                        validation_data=(data_ES_train_val['imgs'], data_ES_train_val['opt_intensity_threshold']),
