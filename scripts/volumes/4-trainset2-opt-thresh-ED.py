...
# run script with KERAS_BACKEND=tensorflow
# also run without buffering: 'python -u ...'
# for example:
# - KERAS_BACKEND=tensorflow python -u 4-trainset2-with-thresholding-ED.py >4-trainset2-with-thresholding-ED.log 2>&1 &

# keras installed from commit 80927fa
# tensorflow installed from commit cdce29e
