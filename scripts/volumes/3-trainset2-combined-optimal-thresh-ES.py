...
(_, _, _, _, 
 ...
 data_optimal_thresh_ES_train_val, labels_optimal_thresh_ES_train_val) = joblib.load('../../data_proc/trainset2_combined_optimal_thresh.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/weights_trainset2_combined_thresh_optimizer_ES.hdf5',
