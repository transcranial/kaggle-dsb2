...
(data_optimal_thresh_ED_train, labels_optimal_thresh_ED_train, 
 ...
 _, _, _, _) = joblib.load('../../data_proc/trainset2and3_optimal_thresh.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/weights_trainset2and3_thresh_optimizer_ED.hdf5',
