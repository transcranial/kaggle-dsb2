...
(validation_studies, training_studies,
 ...
 data_full_validation, labels_full_validation) = joblib.load('../../data_proc/sunnybrook_segmentation_training.pkl')
...
model.add_node(Reshape((64, 8, 8)), name='reshape', input='dropout-1')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/sunnybrook_segmentation.hdf5',
