...
(sunnybrook_contours_validation, sunnybrook_contours_training,
 ...
 data_full_validation, labels_full_validation) = joblib.load('../../data_proc/trainset4_manual500_plus_sunnybrook_local.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/weights_trainset4_local.hdf5',
