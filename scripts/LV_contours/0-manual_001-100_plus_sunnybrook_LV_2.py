...
(sunnybrook_contours_validation, sunnybrook_contours_training,
 ...
 data_full_validation, labels_full_validation) = joblib.load('../../data_proc/manual_plus_sunnybrook_segmentation_training_2.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/manual_001-100_plus_sunnybrook_segmentation_2.hdf5',
