...
(sunnybrook_contours_validation, sunnybrook_contours_training,
 ...
 data_full_validation, labels_full_validation) = joblib.load('../../data_proc/trainset3_manual200_plus_sunnybrook.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/weights_trainset3_full.hdf5',
