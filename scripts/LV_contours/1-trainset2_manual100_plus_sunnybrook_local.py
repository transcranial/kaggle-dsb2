...
(sunnybrook_contours_validation, sunnybrook_contours_training,
 ...
 data_full_validation, labels_full_validation) = joblib.load('../../data_proc/trainset2_manual100_plus_sunnybrook_local.pkl')
...
checkpointer = ModelCheckpoint(filepath='../../model_weights/weights_trainset2_local.hdf5',
